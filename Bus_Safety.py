...
descricao = '''
        ...
        Este projeto não requer Machine Learning e seu trabalho é aplicar suas habilidades de análise e responder 
        diversas perguntas de negócio através de gráficos e storytelling.  
        Para a construção desse projeto, recomendamos a utilização da Linguagem Python e Linguagem SQL e o dataset
        disponível para download no link: [data.world](https://data.world/makeovermonday/2018w51)  
...
Tudo está disponível em meu [GitHub](https://github.com/rbalbinotti/Analise_Risco_Transp_Publico), ou no link do painel 
lateral.
'''
